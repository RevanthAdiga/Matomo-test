...
class __TwigTemplate_a6c4269326a5941bc70162b5d35dc3f70b54c03d390398bd7db99906c4066255 extends Template
{
    private $source;
    private $macros = [];
...
($context["properties"] ?? null), "replace_row_with_subtable", [], "any", true, true, false, 34)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["properties"] ?? null), "replace_row_with_subtable", [], "any", false, false, false, 34), false)) : (false)));
                    ...
                    class=\"";
                        ...
                        // line 43
                        echo "                        ";
                        if ((0 !== twig_compare(((array_key_exists("rowIdentifier", $context)) ? (_twig_default_filter((isset($context["rowIdentifier"]) || array_key_exists("rowIdentifier", $context) ? $context["rowIdentifier"] : (function () { throw new RuntimeError('Variable "rowIdentifier" does not exist.', 43, $this->source); })()))) : ("")), "label"))) {
                            echo "data-label=\"";
                    ...
                    ";
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
                            ...
                            // line 47
                            echo "                        <td class=\"";
                            if (((0 === twig_compare($context["column"], "label")) || twig_in_filter($context["column"], (isset($context["dimensions"]) || array_key_exists("dimensions", $context) ? $context["dimensions"] : (function () { throw new RuntimeError('Variable "dimensions" does not exist.', 47, $this->source); })())))) {
                                echo "label";
                            } else {
                                echo "column";
                            }
                            ...
                            ";
                            // line 50
                            if (((isset($context["isComparing"]) || array_key_exists("isComparing", $context) ? $context["isComparing"] : (function () { throw new RuntimeError('Variable "isComparing" does not exist.', 50, $this->source); })()) && (0 === twig_compare($context["column"], "label")))) {
                                // line 51
...
{% else %}
    ...
    {%- endif -%}
{% endif %}
", "@CoreVisualizations/_dataTableViz_htmlTable.twig", "/var/www/matomo/plugins/CoreVisualizations/templates/_dataTableViz_htmlTable.twig");
    }
}
